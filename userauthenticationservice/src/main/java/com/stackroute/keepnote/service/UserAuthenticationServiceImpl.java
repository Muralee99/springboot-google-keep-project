...
public class UserAuthenticationServiceImpl implements UserAuthenticationService {
	 ...
	 */
    @Override
    public User findByUserNameAndPassword(final String userId, final String password) throws UserNotFoundException
    {
            return userAutheticationRepository.findByUserNameAndUserPassword(userId, password);
    }
    ...
    public boolean saveUser(final User user) throws UserAlreadyExistsException
    {
        ...
        Optional<User> userOptional = userAutheticationRepository.findById(user.getUserName());
        ...
        {
            throw new UserAlreadyExistsException("Entered User already exists in Data base "+user.getUserName());
        }
