...
public class NoteController {
     ...
     */
	@CrossOrigin("http://localhosts:4200")
	...
	public ResponseEntity<Note> createNote(@RequestBody final Note note)
	{
		...
		note.setNoteId(1);
		Note noteinserted = noteService.createNote(note);	
				
		if (noteinserted != null)
		{
			return new ResponseEntity<Note>(noteinserted, HttpStatus.CREATED);
		}
		else
		{
	...
	@RequestMapping(value = "/api/v1/note/category/{userId}/{categoryId}", method = RequestMethod.POST)
	@CrossOrigin("http://localhosts:4200")
	public ResponseEntity<List<Note>> getListofNoteByUserIdCategoryId(@PathVariable final String userId, 
			@PathVariable final String categoryId) {

		List<Note> notes = null;

		notes = noteService.getModifiedNotesByUserIdCategoryId(userId, categoryId);
	...
	@RequestMapping(value = "/api/v1/note/category/{userId}/{categoryId}", method = RequestMethod.PUT)
	@CrossOrigin("http://localhosts:4200")
	public ResponseEntity<List<Note>> getUpdatedListofNoteByUserIdCategoryId(@PathVariable final String userId, 
			@PathVariable final String categoryId, @RequestBody final Category category) {

		List<Note> notes = null;

		notes = noteService.updateNotesByUserIdCategoryId(userId, categoryId, category);
	...
	@CrossOrigin("http://localhosts:4200")
	public ResponseEntity<Note> getNoteByUserId(@PathVariable final String userId, 
			@PathVariable final int noteId) {
